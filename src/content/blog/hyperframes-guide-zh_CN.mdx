...
title: "HyperFrames 用 HTML 写视频：HeyGen 开源的 AI 视频生成框架"
description: "HyperFrames 是 HeyGen 开源的视频合成框架（GitHub 28K+ Stars），让你用 HTML/CSS 编写视频内容，AI Agent 自动渲染出片。支持模板复用、批量生成、AI Agent 集成，告别 Premiere 和 Final Cut。本教程从安装到实战，手把手教你用代码写视频。"
pubDate: 2026-06-20
