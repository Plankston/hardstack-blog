...
description: "HyperFrames 是 HeyGen 开源的视频合成框架，让你用 HTML/CSS 编写视频内容，AI Agent 自动渲染出片。GitHub 28K+ Stars，支持 AI Agent 集成、模板复用、批量生成。本教程从安装到实战，手把手教你用代码写视频，告别传统视频编辑软件，适合内容创作者。"
pubDate: 2026-06-20
