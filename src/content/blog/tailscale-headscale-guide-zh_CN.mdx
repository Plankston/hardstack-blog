...
title: "Tailscale + Headscale 零配置 VPN：自托管 WireGuard 组网教程"
description: "Tailscale 是基于 WireGuard 的零配置 VPN，Headscale 是其开源控制服务器。本教程手把手教你 30 分钟 Docker 部署 Headscale，配置 Tailscale 客户端实现零配置跨网络远程访问 homelab 服务，告别端口转发和 SSH 隧道。"
pubDate: 2026-06-27
