...
凌晨 2 点，你的 Docker 又挂了。你盯着终端，心想：肯定有更好的办法！这就是 OpenCode 要解决的问题。OpenCode 是一个开源 AI 编程助手，现在已经拥有 160K+ GitHub Stars，每月服务 750 万+ 开发者。
...
OpenCode 提供四种安装方式，按你的环境选择最合适的一种。这里我直接给你最简单的方法。
...
> **注意**：npm 安装包可能不是最新版本。如果你想要最新版本，建议使用方式一。
