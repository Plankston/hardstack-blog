...
title: "MiniMind 从零训练大语言模型：3 块钱 2 小时跑完 LLM 全流程"
description: "MiniMind 让你用 3 块钱、2 小时从 0 训练一个 64M 参数的大语言模型，覆盖 pretrain→SFT→RLHF 全流程，纯 PyTorch 原生实现，无需 GPU 集群。本文实测全流程并给出诚实评价，适合想理解 LLM 原理的开发者。"
pubDate: 2026-07-11
