...
这是给 Ollama 配一个像 ChatGPT 一样的聊天界面。需要先确保 Docker 在运行。
...
Open WebUI 设置→网页搜索，填上 SearXNG 地址就行。
...
> 下篇预告：把 Ollama 挂到 Home Assistant 里，让你的智能家居也有个 AI 大脑。
