...
description: "Vaultwarden 是 Bitwarden 的轻量自托管替代品，10 分钟 Docker 部署，支持全平台同步（Windows、macOS、Linux、iOS、Android）、浏览器扩展、团队共享。完全开源免费，数据完全掌控在自己手中，告别云端密码管理器的隐私顾虑。适合 homelab 用户和隐私爱好者。"
pubDate: 2026-06-16
